    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-4">
          <span className="text-xs font-mono font-semibold tracking-wider text-blue-600 dark:text-blue-400 uppercase px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-900 w-max">
          ...
          <ul data-story-reveal className="space-y-3 text-sm text-zinc-700 dark:text-zinc-300 font-medium pt-2">
            <li className="flex items-center gap-2">
              <span className="text-emerald-500 font-bold">✓</span> Instant Sub-20ms Autocomplete (<kbd className="font-mono text-xs bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded">⌘K</kbd>)
            </li>
            <li className="flex items-center gap-2">
              <span className="text-emerald-500 font-bold">✓</span> Verified Google Places Branch Office Cards
            </li>
            <li className="flex items-center gap-2">
              <span className="text-emerald-500 font-bold">✓</span> Side-by-Side 4-ISP Provider Comparison Matrix
            </li>
          </ul>
        </div>
        ...
        >
          <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-4">
            ...
            <span className="text-xs font-mono text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950 px-2 py-0.5 rounded">
              PIN 530026
            </span>
          </div>
